    ...
    static public class Utility
    {
        ...
        public static void ApplySanityLoss(Pawn pawn, float sanityLoss = 0.3f, float sanityLossMax = 1.0f)
        {
            ...
            else if (sanityLoss > 0)
            {
                ...
                Messages.Message(new Message("ROMCH_SanityLossBegun".Translate(pawn.Name.ToStringShort), MessageTypeDefOf.NegativeEvent, pawn));
        ...
        public static void TemporaryGoodwill(Faction faction, bool reset = false)
        {
            ...
            if (!reset)
            {
                ...
                {
                    faction.RelationWith(playerFaction, false).baseGoodwill = faction.PlayerGoodwill;
                }

                faction.RelationWith(playerFaction, false).baseGoodwill = 100;
                faction.RelationWith(playerFaction, false).kind = FactionRelationKind.Neutral;
            }
            else
            {
                faction.RelationWith(playerFaction, false).baseGoodwill = 0;
